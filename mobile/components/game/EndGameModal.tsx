            ...
            <StyledView className="flex-1 bg-white dark:bg-slate-900 px-6 pt-12 pb-6 justify-between">
                ...
                <StyledView className="w-full space-y-3 mb-4">
                    ...
                    <StyledTouchableOpacity
                        ...
                        onPress={onViewStats}
                    >
                        <StyledText className="text-2xl text-slate-800">Stats</StyledText>
                    ...
                    <StyledView className="flex-row gap-3">
                        ...
                        <StyledTouchableOpacity
                            ...
                            onPress={onHome}
                        >
                            <StyledText className="text-xl text-slate-800">Home</StyledText>
                        ...
                        >
                            <StyledText className="text-xl text-slate-800">Archive</StyledText>
                            <View className="w-12 h-12 justify-center items-center">
                                <StyledImage
