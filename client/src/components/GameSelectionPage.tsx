          ...
          <div className="flex flex-col items-stretch space-y-4 mt-1">
            ...
            {!isDesktop && (
              <div ref={statsRowRef} className="relative h-40">
                {/* Global Stats button */}
                <motion.button
                  className="absolute left-0 h-40 w-[calc(50%-0.5rem)] relative px-4 rounded-3xl shadow-sm hover:shadow-md"
                ...
                >
                  <span className="text-xl font-bold text-gray-800 text-center pt-2">
                    {cachedRegionLabel.split(' ')[0]} Stats
                  </span>
                  <img
                    src={mathsHamsterGreen}
                    alt="Global Stats"
                    className="absolute bottom-2 right-2 max-h-[72px] w-auto object-contain"
                  />
                </motion.button>
              </div>
            )}
          ...
          <div className="flex flex-col items-stretch space-y-4 mt-1">
            ...
            {!isDesktop && (
              <div className="relative h-40">
                {/* Local Stats button */}
                <motion.button
                  className="absolute right-0 h-40 w-[calc(50%-0.5rem)] relative px-4 rounded-3xl shadow-sm hover:shadow-md"
