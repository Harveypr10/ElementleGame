...
- **Question Regeneration Workflow**: Triggers Supabase Edge Functions (`reset-and-reallocate-user`, `calculate-demand`) to reset and reallocate questions based on postcode or category changes, displaying a `GeneratingQuestionsScreen`.
